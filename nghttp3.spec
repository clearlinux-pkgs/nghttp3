...
Version  : 1.2.0
Release  : 5
URL      : https://github.com/ngtcp2/nghttp3/releases/download/v1.2.0/nghttp3-1.2.0.tar.xz
Source0  : https://github.com/ngtcp2/nghttp3/releases/download/v1.2.0/nghttp3-1.2.0.tar.xz
Source1  : https://github.com/ngtcp2/nghttp3/releases/download/v1.2.0/nghttp3-1.2.0.tar.xz.asc
...
%prep
%setup -q -n nghttp3-1.2.0
cd %{_builddir}/nghttp3-1.2.0
pushd ..
cp -a nghttp3-1.2.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1708464654
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libnghttp3.so.9.2.0
/usr/lib64/libnghttp3.so.9
/usr/lib64/libnghttp3.so.9.2.0
