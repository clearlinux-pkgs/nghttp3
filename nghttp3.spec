...
Source0  : https://github.com/ngtcp2/nghttp3/releases/download/v1.8.0/nghttp3-1.8.0.tar.gz
Source1  : https://github.com/ngtcp2/nghttp3/releases/download/v1.8.0/nghttp3-1.8.0.tar.gz.asc
...
%setup -q -n nghttp3-1.8.0
cd %{_builddir}/nghttp3-1.8.0
pushd ..
cp -a nghttp3-1.8.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1740150808
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libnghttp3.so.9.2.6
