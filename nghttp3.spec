...
Source0  : https://github.com/ngtcp2/nghttp3/releases/download/v1.10.1/nghttp3-1.10.1.tar.gz
Source1  : https://github.com/ngtcp2/nghttp3/releases/download/v1.10.1/nghttp3-1.10.1.tar.gz.asc
...
%setup -q -n nghttp3-1.10.1
cd %{_builddir}/nghttp3-1.10.1
pushd ..
cp -a nghttp3-1.10.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1748354293
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libnghttp3.so.9.2.9
/usr/lib64/libnghttp3.so.9
/usr/lib64/libnghttp3.so.9.2.9
