...
Version  : 1.7.0
Release  : 10
URL      : https://github.com/ngtcp2/nghttp3/releases/download/v1.7.0/nghttp3-1.7.0.tar.gz
Source0  : https://github.com/ngtcp2/nghttp3/releases/download/v1.7.0/nghttp3-1.7.0.tar.gz
Source1  : https://github.com/ngtcp2/nghttp3/releases/download/v1.7.0/nghttp3-1.7.0.tar.gz.asc
...
%setup -q -n nghttp3-1.7.0
cd %{_builddir}/nghttp3-1.7.0
pushd ..
cp -a nghttp3-1.7.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1735090635
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libnghttp3.so.9.2.5
/usr/lib64/libnghttp3.so.9
/usr/lib64/libnghttp3.so.9.2.5
